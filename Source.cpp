...
//Variables que definen los pines de entrada de la RaspberryPi 3:
//GPIO 17 es entrada 1 en WiringPi
//GPIO 22 es entrada 3 en WiringPi
int boton_salir = 1;
int boton_reinicio = 3;
//Variables que se utilizaran en el codigo para asignar los valores de las lecturas digitales de los pines 1 y 3
int b_salir = 1;
int b_reinicio = 1;
float velocidadX = 15;
float velocidadY = 10;
...
void inicializar() {
	...
	bola.vx = (bola.vx)*(velocidadX);
	bola.vy = (bola.vy)*(velocidadY);
...
void usuario(ALLEGRO_KEYBOARD_STATE &estadoTeclado, ALLEGRO_EVENT_QUEUE *&evento_cola, ALLEGRO_EVENT &eventos, ALLEGRO_FONT *fuente) {
	...
	while (true) {
		...
		if (al_key_down(&estadoTeclado, ALLEGRO_KEY_ENTER)) {
			...
			al_set_target_bitmap(buffer);
			if (al_key_down(&estadoTeclado, ALLEGRO_KEY_A)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "A"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_B)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "B"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_C)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "C"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_D)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "D"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_E)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "E"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_F)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "F"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_G)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "G"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_H)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "H"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_I)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont+7, 340, 0, "I"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_J)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "J"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_K)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "K"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_L)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "L"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_M)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "M"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_N)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "N"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_O)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "O"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_P)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "P"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_Q)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "Q"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_R)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "R"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_S)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "S"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_T)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "T"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_U)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "U"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_V)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "V"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_W)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "W"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_X)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "X"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_Y)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "Y"); }
			else if (al_key_down(&estadoTeclado, ALLEGRO_KEY_Z)) { al_draw_text(fuente, al_map_rgb(172, 190, 250), cont, 340, 0, "Z"); }
			actualizar_pantalla();
			al_rest(0.2);
		}
		cont = cont + 10;
...
void juego(ALLEGRO_KEYBOARD_STATE &estadoTeclado, ALLEGRO_EVENT_QUEUE *&evento_cola, ALLEGRO_EVENT &eventos, ALLEGRO_FONT *fuente, ALLEGRO_EVENT_QUEUE *cola_timer, ALLEGRO_EVENT *evento_timer) {
...
void salirJuego(ALLEGRO_EVENT_QUEUE *&evento_cola, ALLEGRO_TIMER *timer) {
	...
	al_destroy_bitmap(tres_vidas); al_destroy_bitmap(cero_vidas); al_destroy_bitmap(fallido); al_destroy_bitmap(perdio); al_destroy_font(fuente); al_destroy_bitmap(final_screen); al_destroy_bitmap(gano); al_destroy_display(display); al_destroy_bitmap(inicio); al_destroy_bitmap(presione); al_destroy_timer(timer);
...
int main(int argc, char **argv) {
    wiringPiSetup ();
    softToneCreate(PIN);
    pinMode (boton_salir, INPUT);
    pinMode (boton_reinicio, INPUT);
    b_salir = digitalRead(boton_salir);
    b_reinicio = digitalRead(boton_reinicio);
	if (!al_init()) {
	...
	while (true) {
		if (salir) {
			...
			juego(estadoTeclado, evento_cola, eventos, fuente, cola_timer, &evento_timer);
			...
			if (!reset && !salir) { //si no hay ningun boton presionado, se queda alli hasta que presione alguno
				...
				al_rest(2.0); //Aqui debe esperar por un evento, pero no esta esperando porque se volvio loco el Allegro
				al_wait_for_event(evento_cola, &eventos);
			}
		}
